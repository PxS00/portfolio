...
const HeroSection = () => {
  ...
  return (
    <section className="relative z-30 flex flex-col items-center justify-start overflow-hidden pt-20 pb-2 text-center sm:min-h-[75vh] sm:justify-center sm:py-24">
      <GridPattern />
      <ShadowEffect />
