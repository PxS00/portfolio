  ...
  return (
    <div className="container mx-auto px-6 py-32 lg:px-12">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <Link
          to="/projects"
          className="group mb-8 inline-flex items-center gap-2 text-sm font-medium text-(--text-color)/70 transition-colors hover:text-(--primary-color)"
        >
        ...
        {/* Header */}
        <div className="mb-10 flex flex-col gap-6 border-b border-white/5 pb-10 md:flex-row md:items-start md:justify-between">
          ...
          <a
            ...
            className="group inline-flex shrink-0 items-center gap-2 rounded-lg border border-(--primary-color)/30 px-6 py-3 font-semibold text-(--primary-color) transition-all hover:bg-(--primary-color)/10"
          >
            Ver no GitHub
